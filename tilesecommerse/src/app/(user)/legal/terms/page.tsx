                    ...
                    <div className="prose prose-slate max-w-none">
                        <section className="mb-8">
                            ...
                            <p className="text-slate-600 leading-relaxed mb-4">
                                Welcome to SLN Tiles Showroom. By accessing and using our website, you accept and agree to be bound by these
                        ...
                        <section className="mb-8">
                            ...
                            <p className="text-slate-600 leading-relaxed mb-4">
                                All content on this website, including images, text, logos, and designs, is the property of SLN Tiles Showroom
